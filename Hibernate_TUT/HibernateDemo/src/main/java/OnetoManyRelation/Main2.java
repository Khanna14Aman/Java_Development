...
public class Main2 {
    public static void main(String [] args){
        ...
        Student1toMany2 student1toMany2 = new Student1toMany2();
        student1toMany2.setSid(102);
        student1toMany2.setName("Ayush");
        student1toMany2.setLaptop1toManyList(Arrays.asList(laptop1toMany3));

        laptop1toMany1.setStudent1toMany2(student1toMany1);
        laptop1toMany2.setStudent1toMany2(student1toMany1);
        laptop1toMany3.setStudent1toMany2(student1toMany2);

        SessionFactory sessionFactory = new Configuration().addAnnotatedClass(Student1toMany2.class).addAnnotatedClass(Laptop1toMany2.class).configure("hibernate.cfg2.xml").buildSessionFactory();
